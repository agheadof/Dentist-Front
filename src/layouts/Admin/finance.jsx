...
export default function Finance({ ...props }) {
  ...
  const columns = [
    ...
    {
      field: "action",
      renderCell: (value) => renderActionColumn(value),
      headerName: "Action",
      minWidth: "50",
      resizable: false,
      headerAlign: "center",
  ...
  const financeCol = [
    ...
    {
      field: "action",
      renderCell: (value) => renderActionColumn2(value),
      headerName: "Action",
      minWidth: "50",
      resizable: false,
      headerAlign: "center",
        ...
        <Grid item xs={8}>
          <ThemeProvider theme={theme}>
            ...
            <div style={{ display: "flex", justifyContent: "end" }}>
              <DrButton
                ...
                onClick={() => setCurrentTarget("addlaboratory")}
              >
                Add
              </DrButton>
            </div>
          ...
          <ThemeProvider theme={theme}>
            ...
            <div style={{ display: "flex", justifyContent: "end" }}>
              <DrButton
                style={{ marginTop: "5px", marginBottom: "20px" }}
                onClick={() => setCurrentTarget("expenses")}
              >
                Add
              </DrButton>
            </div>
